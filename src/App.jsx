...
const items = [
  {
    ...
    "title": "Nagoya event opportunity",
    "category": "event",
    "area": "Nagoya",
    "summary": "Bowling score diary, event board and local ranking hub for weekend players and venue communities. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 92,
    ...
    "revenue": "equipment affiliate"
  },
  {
    "id": "bowling-score-hub-2",
    "title": "Tokyo personal score opportunity",
    "category": "personal score",
    "area": "Tokyo",
    "summary": "Bowling score diary, event board and local ranking hub for weekend players and venue communities. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 85,
    "status": "verified seed",
    ...
    "revenue": "event promotion"
  },
  {
    "id": "bowling-score-hub-3",
    "title": "Osaka diary opportunity",
    "category": "diary",
    "area": "Osaka",
    "summary": "Bowling score diary, event board and local ranking hub for weekend players and venue communities. This page is designed as a searchable seed record with review intent, update status and conversion context.",
    "score": 78,
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', category: 'event', body: '' })
  ...
  function submitPost(event) {
    ...
    setForm({ title: '', category: 'event', body: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <span className="brand">bowlscore.jp / bowling-score-hub</span>
          <h1>Bowling Score Hub</h1>
          <p>Bowling score diary, event board and local ranking hub for weekend players and venue communities.</p>
        </div>
        <aside className="answer-box">
          <small>AI overview answer</small>
          <strong>Bowling Score Hub helps users compare, verify and act faster.</strong>
      ...
      <section className="ugc-section">
        ...
        <form className="ugc-form" onSubmit={submitPost}>
          ...
          <select value={form.category} onChange={(event) => setForm({ ...form, category: event.target.value })}>
            {["event","personal score","diary","equipment","lane info"].map((item) => <option key={item}>{item}</option>)}
          </select>
